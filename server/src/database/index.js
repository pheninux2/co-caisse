...
class Database {
  ...
  async initialize() {
    ...
    try {
      ...
      // ── floor_plans + tables ──────────────────────
      // Plan de salle visuel interactif
      await conn.query(`
      ...
      `);
      await conn.query(`INSERT IGNORE INTO \`floor_plans\` (\`id\`, \`name\`) VALUES ('default-floor-plan', 'Salle principale')`);
      ...
      await conn.query(`
        CREATE TABLE IF NOT EXISTS \`tables\` (
          ...
          CONSTRAINT \`fk_tables_floor_plan\`
