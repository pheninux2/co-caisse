...
CocaisseApp.prototype.loadKitchenOrders = async function() {
  ...
  try {
    const response = await fetch(`${API_URL}/orders/kitchen/active`, {
      headers: this.getAuthHeaders()
    });
...
CocaisseApp.prototype.takeKitchenOrder = async function(orderId) {
  try {
    const response = await fetch(`${API_URL}/orders/${orderId}/kitchen-handle`, {
      method: 'POST',
      headers: this.getAuthHeaders()
    });
    if (!response.ok) {
...
CocaisseApp.prototype.saveKitchenComment = async function(orderId) {
  ...
  try {
    const response = await fetch(`${API_URL}/orders/${orderId}/kitchen-comment`, {
      method: 'POST',
      headers: this.getAuthHeaders(),
